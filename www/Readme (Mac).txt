...
-------------------------------------------------------------------------------
HEALTH EQUITY ASSESSMENT TOOLKIT (HEAT), BUILT-IN DATABASE EDITION, VERSION 2.1
...
Results can be exported and saved in different formats. This version 
of HEAT uses data from the WHO Health Equity Monitor database (2018 update).

This package contains the Health Equity Assessment Toolkit (HEAT), Built-in 
database edition, Version 2.1, the WHO Health Equity Monitor database (2018 
update) and supporting software.
...
Your use of the materials in this package is subject to the Terms of Use and 
Software Licence agreement - see below - and by using these materials you 
affirm that you have read, and will comply with, the terms of those documents.

-------------------------------------------------------------------------------
INSTALLATION

In order to run HEAT on your device, you require the “R” statistical software 
and a web browser. In the standalone package of the Toolkit, WHO has provided a 
portable version of “R” and the portable edition of the web browser Mozilla 
Firefox. This does not imply in any manner that the use of these products are 
endorsed or recommended by the World Health Organization in preference to 
others of a similar nature. R Portable and Firefox Portable do not require any 
installation.

To run HEAT on your Mac, download the compressed “HEAT for Mac” (zip) file, 
unzip the file and save the content to your computer's hard drive. Select the 
“HEAT for Mac” folder and double-click the “Start_HEAT.command” file. The 
toolkitshould automatically open in a Firefox Portable browser window. 

If HEAT does not open automatically, you may have to change your computer’s 
security settings. You can change the settings by pressing the Control key, 
then clicking the “Start_HEAT.command” file and then choosing Open from the 
shortcut menu. This will save HEAT as an exception to your security settings, 
and you can open the toolkit in the future by double-clicking the 
“Start_HEAT.command” file. 

Alternatively, you can change your security settings in System Preferences: 
Open System Preferences (by clicking the Apple logo on the top left corner of 
your screen) and click the Security & Privacy icon. In the General tab you may 
see a note saying that HEAT was blocked from opening. Click the “Open Anyway” 
button to open HEAT. If you don’t see this note, you can change your settings 
by setting “Allow apps downloaded from” to “Anywhere”. Note that you may have 
to unlock your settings by clicking the lock on the bottom left corner of the 
window and entering your administrative username and password in order to make 
this change. You will now be able to run HEAT by double-clicking the 
“Start_HEAT.command” file. 

It is recommended to copy the content of this medium to your computer’s hard 
drive. 
...
- Update of the built-in Health Equity Monitor database (2018 update). 

June 2017 ñ Version 2.0
- Restructuring of source code for improved performance, including
  - Improving the cascade of user selections to minimize plot redrawing, and 
  - Pre-calculating 95% confidence intervals of summary measures (instead of 
    on the fly). 
- Addition of a new tab under Explore Inequality featuring detailed bar graphs. 
- Addition of accordion-style menus for graph options and table options.
- Alteration of variable names in order to conform with the terminology used in 
  HEAT Plus, including
  - Changing “country” to “setting”, and
  - Changing “national average” to “setting average”.
- Revision of summary measures of inequality, including
  - Dropping the previous Relative Index of Inequality (RII), 
  - Renaming the previous Kunst-Mackenbach Index (KMI) to Relative Index 
    of Inequality (RII), 
  - Revising the formulas for the Slope Index of Inequality (SII) and the 
    Relative Index of Inequality (RII), both for the estimate and analytic 
    95% confidence intervals, 
  - Adding the Weighted Index of Disparity (IDIS_W), 
  - Dropping the bootstrap 95% confidence intervals, 
  - Adding the simulation-based 95% confidence intervals for the Index of 
    Disparity (IDIS), Mean Difference from Mean (MDM), Mean Difference from 
    Best-Performing Subgroup (MDB) and Weighted Index of Disparity (IDIS_W), 
  - Calculating the average as the weighted average based on the estimate and 
population size.

January 2017 - Version 1.1
- Update of the built-in Health Equity Monitor database (2016 update). 
...
software does not imply that “R” or Firefox products are endorsed or 
...
To report any software problems, please send an email to heat@who.int with 
details on


  - What type of problem you encountered?
  - Where you encountered the problem (i.e. which tab was selected)?
  - What variables were selected when you encountered the problem (i.e. which 
    country, year(s), health indicator(s), inequality dimension(s) and, if 
    applicable, summary measure(s))?
  - Whether the problem occurred systematically or randomly (i.e. were you able
